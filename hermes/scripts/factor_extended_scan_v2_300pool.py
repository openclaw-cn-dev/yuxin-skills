...
STOCK_POOL_EXT = [
    ...
    # ====== 中证 500 + 创业板 + 中小盘 加 101 只 (2026-08-14 阶段 2) ======
    ('sz002001', '新和成'), ('sz002007', '华兰生物'), ('sz002008', '大族激光'),
    ('sz002013', '中航机电'), ('sz002028', '思源电气'), ('sz002030', '达安基因'),
    ('sz002038', '双鹭药业'), ('sz002051', '中工国际'), ('sz002120', '韵达股份'),
    ('sz002153', '石基信息'), ('sz002180', '纳思达'), ('sz002202', '金风科技'),
    ('sz002223', '鱼跃医疗'), ('sz002250', '联化科技'), ('sz002262', '恩华药业'),
    ('sz002271', '东方雨虹'), ('sz002311', '海大集团'), ('sz002353', '杰瑞股份'),
    ('sz002384', '东山精密'), ('sz002422', '科伦药业'), ('sz002439', '启明星辰'),
    ('sz002456', '欧菲光'), ('sz002465', '海格通信'), ('sz002466', '天齐锂业'),
    ('sz002493', '荣盛石化'), ('sz300014', '亿纬锂能'), ('sz300017', '网宿科技'),
    ('sz300024', '机器人'), ('sz300026', '红日药业'), ('sz300058', '蓝色光标'),
    ('sz300070', '碧水源'), ('sz300072', '三聚环保'), ('sz300085', '银之杰'),
    ('sz300088', '长信科技'), ('sz300101', '振芯科技'), ('sz300115', '长盈精密'),
    ('sz300133', '华策影视'), ('sz300182', '捷成股份'), ('sz300315', '掌趣科技'),
    ('sz300324', '旋极信息'), ('sz300383', '光环新网'), ('sz300450', '先导智能'),
    ('sz300601', '康泰生物'), ('sz300699', '光威复材'), ('sz300750', '宁德时代'),
    ('sz300759', '康龙化成'), ('sz300760', '迈瑞医疗'), ('sh600004', '白云机场'),
    ('sh600017', '日照港'), ('sh600026', '中远海能'), ('sh600062', '华润双鹤'),
    ('sh600079', '人福医药'), ('sh600143', '金发科技'), ('sh600177', '雅戈尔'),
    ('sh600196', '复星医药'), ('sh600267', '海正药业'), ('sh600315', '上海家化'),
    ('sh600332', '白云山'), ('sh600446', '金证股份'), ('sh600522', '中天科技'),
    ('sh600535', '天士力'), ('sh600600', '青岛啤酒'), ('sh600660', '福耀玻璃'),
    ('sh600674', '川投能源'), ('sh600688', '上海石化'), ('sh600717', '天津港'),
    ('sh600820', '隧道股份'), ('sh600871', '石化油服'), ('sh600886', '国投电力'),
    ('sh600900', '长江电力'), ('sh600967', '内蒙一机'), ('sh600998', '九州通'),
    ('sh601008', '连云港'), ('sh601139', '深圳燃气'), ('sh601233', '桐昆股份'),
    ('sh601333', '广深铁路'), ('sh601555', '东吴证券'), ('sh601880', '辽港股份'),
    ('sh601992', '金隅集团'),
]
