...
cd /Users/hua/6-产品研发/渔芯独角兽/02-产品开发综合平台/01-FindEra寻元 && docker compose stop >>"$LOG" 2>&1 || {
  echo "❌ FindEra 寻元停止失败，详见 $LOG"; exit 1; }

cd /Users/hua/6-产品研发/渔芯独角兽/02-产品开发综合平台/02-RKR知识库 && docker compose stop >>"$LOG" 2>&1 || {
