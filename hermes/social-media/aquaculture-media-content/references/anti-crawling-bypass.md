...
> **状态**：基于 100+ 实测数据点沉淀，反爬常识 + 踩过的坑全在这
...
Referer = "https://www.google.com/"  # 或 源站首页
...
from playwright_stealth import stealth_sync  # 需装
...
**解决**：
```python
# 必须先访问 weibo.com 拿 SUB cookie
# 然后带 cookie 再访问 s.weibo.com
```
...
5. **数据沉淀 > 实时抓取** —— 跑 30 天攒够爆款库再做行业分析

---

## 🔗 配套文件
- `C:\Users\Administrator\Desktop\知识库\反爬绕过实战手册.md`（完整版 7KB）
- `C:\Users\Administrator\Desktop\知识库\search_toutiao.py`（通用抓取脚本）
- `C:\Users\Administrator\Desktop\知识库\search_toutiao_使用手册.md`（使用手册）
