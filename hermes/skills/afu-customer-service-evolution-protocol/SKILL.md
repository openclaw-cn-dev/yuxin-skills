...
| **🆕 L1 vs afu 镜像反转** | **N+53** | 默认 hub L1 版本号 v1.35.0（18,624 bytes）反而新于 afu 本地镜像 v1.33.0（20,148 bytes）；跨 profile 看到不一致版本 | 反向同步未闭合；N+20 假设"afu 本地新于 L1"被打破 | **指针版模式**（N+50 决策包方案 A）；L1 缩到 ~3K 字节指针 |
