...
This skill targets **mark classes**, not reverse-engineered private detectors. Details below come from public docs and the research literature. Algorithms may change.
