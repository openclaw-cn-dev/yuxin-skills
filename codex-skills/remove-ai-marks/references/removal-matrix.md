...
| PDF XMP / info | exiftool `-all=` preferred, then qpdf, then optional Ghostscript | `clean_file.py` | Loses PDF metadata; degraded without exiftool / qpdf | Partial without tools |
...
1. **Inspect** (`inspect_file.py` or a specific inspect_*).
